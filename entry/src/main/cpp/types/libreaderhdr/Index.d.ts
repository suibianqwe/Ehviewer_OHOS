...
export const createCompatibleSdrPixelMap: (source: image.PixelMap) => Promise<image.PixelMap>;
export const createScaledCompatibleSdrPixelMap: (source: image.PixelMap, width: number,
